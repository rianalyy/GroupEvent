...
class LoginView extends ConsumerWidget {
  ...
  InputDecoration _deco(String hint, IconData icon, {Widget? suffix}) => InputDecoration(
    ...
    suffixIcon: suffix, filled: true, fillColor: Colors.white.withOpacity(0.10),
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Column(children: [
                  ...
                  const Text('Connectez-vous à GroupEvent',
                ...
                TextField(style: const TextStyle(color: AppColors.white),
                    onChanged: notifier.setEmail, keyboardType: TextInputType.emailAddress,
                    decoration: _deco('exemple@email.com', Icons.email_outlined)),
                ...
                TextField(
                  ...
                  onChanged: notifier.setPassword, obscureText: auth.obscurePassword,
                  decoration: _deco('Votre mot de passe', Icons.lock_outline_rounded,
                      suffix: IconButton(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: auth.status == AuthStatus.loading ? null : () async {
                      final ok = await notifier.sendOtpForLogin();
                    ...
                    child: auth.status == AuthStatus.loading
                        ...
                        : const Text('Se connecter', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.white)),
                  ),
                ),
                const SizedBox(height: 20),
                Center(
                  child: GestureDetector(
                    onTap: () { notifier.resetForm(); Navigator.pushReplacementNamed(context, AppRoutes.register); },
